%% FRPCalibrationTask
%  FRPCalibrationTask it inherits CopyTask. It decides on the next trials to show, decides if the session is
...
%
%%
classdef FRPCalibrationTask < CopyTask
    ...
    properties (Constant)
        ...
        copyPhraseSentencesFile='copyphraseSentencesFRP.txt';
    ...
    %% Properties of the FRPCalibrationTask class
    properties
    ...
    %% Methods of the FRPCalibrationTask class
    methods
        %% self=FRPCalibrationTask(symbolStructArray,RSVPKeyboardParams,scoreStruct,operationMode)
...
%             end
        ...
        function checkTaskUpdateCriteria(self)
            ...
            self.currentInfo.taskEndedFlag=self.currentInfo.taskEndedFlag || (self.targetTrialCounter>=self.decisionObj.languageModelWrapperObject.numberOfTargetSamples && self.nonTargetTrialCounter>=self.decisionObj.languageModelWrapperObject.numberOfNonTargetSamples);
        end
    end
