...
% Available Options for querying are:
% '1': random query selection
% '2': Nbest or MI method
% '3': Momentum-base method
% '4': proposed method in "Optimal Query Selection Using Multi-Armed Bandits"

% Available Options for taskType are:
...
RSVPKeyboardParams.evidenceEval.nextTrialFunctions.params{1}.Typing.MaximumNumberofSequences=12;
